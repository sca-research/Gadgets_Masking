...
/*
    ISW_Belaid_MULT(INPUT: input_a[Mask_ORD+1], INPUT: input_b[Mask_ORD+1],INPUT: uint8_t * rnd, OUTPUT: c[Mask_ORD+1])
    c = a * b
        The number of randomness: Even Mask_ORD: (Mask_ORD * (Mask_ORD)) /4 + Mask_ORD;
                                  Odd  Mask_ORD: ( (Mask_ORD * (Mask_ORD)) -1) /4 + Mask_ORD;
        */

    void ISW_Belaid_MULT(uint8_t* input_a, uint8_t* input_b,uint8_t* rnd, uint8_t* c)
    {
