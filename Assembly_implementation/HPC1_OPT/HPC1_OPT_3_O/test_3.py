...
def uart(ser_port, num_repeat):
    ...
    input_length = 18  # a: 1B, b: 1B, rnd: 16B (3B for masking a, 3B for masking b, 4B for z(refresh), 6B for Dom_indep_3 multiplication)
    ...
    for i in range(num_repeat):
        ...
        #print('- input{}:  [{}]'.format(i, input_data.hex()))
        #print('- rnd{}:  [{}]'.format(i, rnd.hex()))
