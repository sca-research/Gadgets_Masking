...
/*The number of randomness for Dom_dep: Mask_order + 1 + Mask_order*(Mask_order + 1)/2: 5+4*(5+1)/2=15
...
int main( int argc, char* argv[]){
    ...
    while(true) {
        ...
        Dom_dep_4(shares_a, shares_b, rnd_dom_4, shares_ab);
